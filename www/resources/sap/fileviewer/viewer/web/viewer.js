    ...
    var PDFEntitiesViewer = (function PDFEntitiesViewerClosure() {
        ...
        PDFEntitiesViewer.prototype = {
            ...
            render: function PDFEntitiesViewer_render(params) {
                ...
                if (!window.sap.es.suvDocument.highlightsNoOverlaps) {
                ...
                window.sap.es.suvDocument.offCalculatePromise.then(function(highlightsWithPage){
                    this._renderTree(highlightsWithPage, entities);
                }.bind(this));
            ...
            _getBaseMap: function(highlightsWithPage){
                ...
                for (var k = 0; k < highlightsWithPage.length; k++) {
                    var entity = highlightsWithPage[k];
                    for (var j = 0; j< entity.types.length; j++) {
                        var entityType = entity.types[j];
                        entityTypesMap[entityType] = entityTypesMap[entityType] || {};
                        entityTypesMap[entityType].count = (entityTypesMap[entityType].count || 0) + 1;
                        entityTypesMap[entityType].entities = entityTypesMap[entityType].entities || {};
                        entityTypesMap[entityType].entities[entity.text] = entityTypesMap[entityType].entities[entity.text] || [];
                        entityTypesMap[entityType].entities[entity.text].push({
                            'from': entity.from,
                            'to': entity.to,
                            'page': entity.pdfFrom.page
                        });
                    }
                }
            ...
            _renderEntityButton: function(entityTypesMap, currentEntityType, currentEntity){
                ...
                entityButton.textContent = currentEntity + ": " + entityTypesMap[self.currentEntityType].entities[currentEntity].length;
            ...
            _renderEntityTypeButton: function(entityTypesMap, currentEntityType){
                ...
                entityTypeButton.textContent = currentEntityType + ': ' + entityTypesMap[currentEntityType].count;
                entityTypeButton.value = currentEntityType;
                //entityTypeButton.setAttribute("aria-role", "listbox");
                entityTypeButton.setAttribute("aria-haspopup", "listbox");
            ...
            _renderTree: function(highlightsWithPage, entities){
