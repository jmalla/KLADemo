 ...
 * ${copyright}
 */
sap.ui.predefine('sap/fileviewer/library',['jquery.sap.global','sap/ui/core/library'],function(q,l){"use strict";sap.ui.getCore().initLibrary({name:"sap.fileviewer",dependencies:["sap.ui.core"],types:[],interfaces:[],controls:["sap.fileviewer.FileViewer"],elements:[],noLibraryCSS:false,version:"1.61.0"});return sap.fileviewer;});
sap.ui.require.preload({
	"sap/fileviewer/manifest.json":'{"_version":"1.9.0","sap.app":{"id":"sap.fileviewer","type":"library","embeds":[],"applicationVersion":{"version":"1.61.0"},"title":"UI5 library: sap.fileviewer","description":"UI5 library: sap.fileviewer","resources":"resources.json","offline":true},"sap.ui":{"technology":"UI5","supportedThemes":["base","sap_belize","sap_belize_plus","sap_hcb"]},"sap.ui5":{"dependencies":{"minUI5Version":"1.61","libs":{"sap.ui.core":{"minVersion":"1.61.0"}}},"library":{"i18n":false,"content":{"controls":["sap.fileviewer.FileViewer"],"elements":[],"types":[],"interfaces":[]}}}}'
